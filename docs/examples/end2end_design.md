...
| Aspect | Traditional Design | End-to-End Design |
|--------|-------------------|-------------------|
| **Approach** | Optimize optics, then add processing | Joint optimization |
| **Objective** | Optical metrics (MTF, spot size) | Task performance |
| **Flexibility** | General purpose | Application-specific |
| **Design Time** | Weeks to months | Days (with GPU) |
| **Innovation** | Based on experience | Data-driven discovery |
