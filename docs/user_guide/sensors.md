...
|-----------|-------------|---------------|
| **pixel_size** | Physical pixel size | 1-20 μm |
| **bit_depth** | ADC resolution | 8-16 bits |
| **qe** | Quantum efficiency | 0.3-0.9 |
| **dark_current** | Dark current noise | 0.001-1 e-/s |
| **read_noise** | Read noise | 1-10 e- |
| **full_well** | Well capacity | 1k-100k e- |
...
The recommended way to capture images end-to-end is via `Camera`.
...
```python
# Ensure GPU usage
sensor = RGBSensor(size=(36.0, 24.0), res=(1920, 1080), device='cuda')
```
...
* Combine with [Lens Systems](lens_systems.md) for complete imaging simulation
* Learn about [Neural Networks](neural_networks.md) for computational photography
* See [Image Simulation](../examples/image_simulation.md) for complete examples
