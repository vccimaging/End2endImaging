...
| Name | Type | Refractive Index (550nm) | Application |
|------|------|--------------------------|-------------|
| N-BK7 | Crown glass | 1.519 | General purpose |
| N-SF11 | Flint glass | 1.785 | Chromatic correction |
| PMMA | Plastic | 1.492 | Low cost optics |
| Fused Silica | Glass | 1.460 | UV/IR applications |
...
* Learn about [Sensors](sensors.md) for complete imaging simulation
* See [Automated Lens Design](../examples/automated_lens_design.md) for optimization workflows
* Explore the [Optics API](../api/optics.md) for detailed API reference
