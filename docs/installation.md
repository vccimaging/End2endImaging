...
If this returns `False`, you may need to reinstall PyTorch with CUDA support. Visit the [PyTorch installation page](https://pytorch.org/get-started/locally/) for instructions.
...
For more help, join our [Slack workspace](https://join.slack.com/t/deeplens/shared_invite/zt-2wz3x2n3b-plRqN26eDhO2IY4r_gmjOw) or contact the developers.
